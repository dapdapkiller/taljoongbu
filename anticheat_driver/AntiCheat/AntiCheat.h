...
#define IO_CTL_PROCESS_PIPE_FIND CTL_CODE(FILE_DEVICE_UNKNOWN, 0x814, METHOD_NEITHER , FILE_SPECIAL_ACCESS)
#define IO_CTL_PROCESS_CALLBACK_REGISTER CTL_CODE(FILE_DEVICE_UNKNOWN, 0x815, METHOD_NEITHER, FILE_SPECIAL_ACCESS)
